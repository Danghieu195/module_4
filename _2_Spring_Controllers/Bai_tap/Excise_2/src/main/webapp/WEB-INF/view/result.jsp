...
<form method="post" action="/calculate">
    ...
    <div>
        ...
        <input type="text" id="firstOperand" name="firstOperand" value="${firstOperand}">
    </div>

    <div>
        <label>Second Operand: </label>
        <input type="text" id="secondOperand" name="secondOperand" value="${secondOperand}">
    </div>

    <div>
        <label>Answer: </label>
        <input type="text" value="${finalAnswer}">
    </div>
